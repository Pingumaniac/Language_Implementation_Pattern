...
public class SymbolTable {
    ...
    public static final BuiltInTypeSymbol _ptr = new BuiltInTypeSymbol("ptr", tPTR);
    ...
    public static final Type[] indexToType = { null, _boolean, _char, _int, _float, _void, null };
