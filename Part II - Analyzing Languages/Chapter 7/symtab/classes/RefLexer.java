...
public class RefLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "T__7", "EXTENDS", 
			"MEMBERS", "METHOD_DECL", "FIELD_DECL", "VAR_DECL", "ARG_DECL", "CALL", 
			"EXPR", "ID", "INT"
		};
	}
	...
	public RefLexer(CharStream input) {
		super(input);
