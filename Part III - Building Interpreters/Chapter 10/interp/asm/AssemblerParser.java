...
public class AssemblerParser extends Parser {
	...
	public final GlobalsContext globals() throws RecognitionException {
		...
		try {
			...
			setState(33);
			match(NEWLINE);
			 defineDataSize((INT!=null?Integer.parseInt(INT.getText()):0)); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(46);
			match(NEWLINE);
			 defineFunction(((FunctionDeclarationContext)_localctx).name, (a!=null?Integer.parseInt(a.getText()):0), (n!=null?Integer.parseInt(n.getText()):0)); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
